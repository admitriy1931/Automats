...
public class GreedyShortestWordFindingTests {
    @Test
    public void SimpleTest() throws CloneNotSupportedException {
        ...
        syncAut = GreedySyncWordFinding.greedyShortestWordFindingAlg(syncAut);

        Assertions.assertEquals("aa", syncAut.shortestSyncWord);
    }
}
