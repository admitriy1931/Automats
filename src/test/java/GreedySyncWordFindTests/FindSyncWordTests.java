...
public class FindSyncWordTests {
    @Test
    public void FindSyncWordTest1 () throws CloneNotSupportedException {
        ...
        System.out.println(GreedySyncWordFind.FindSyncWord(initial));
    }
}
